...
1. интроспектировать существующую бд и получить и получить схему моделей (интроспектировать - получить тип и структуру объекта)
2. либо описать модели в схема файле с синтаксисом похожим на graphql
